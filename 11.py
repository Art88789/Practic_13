def is_valid_sudoku(board):
    """Проверяет, является ли текущее состояние доски Судоку валидным.

    Валидность определяется отсутствием повторяющихся цифр от 1 до 9
    в каждой строке, каждом столбце и каждом подблоке 3x3. Пустые
